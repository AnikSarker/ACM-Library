Lets say you are given a rooted tree and edges are coloured red and blue. Red player will cut red edges and blue player will cut blue edges. When 
a edge is cut, then the subtree under it is cut. 
Who will win?
...
or minus cur x times. And for every next edges we make cur = cur / 2 and add it to our grundy value depending on the edge colour.
